                            ...
                            <div className="p-6 border-b border-gray-200">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <p><strong>Items Price:</strong> Rs {data.itemsPrice}</p>
                                        <p><strong>Tax Price:</strong> Rs {data.taxPrice}</p>
                                        <p><strong>Shipping Price:</strong> Rs {data.shippingPrice}</p>
                                        <p><strong>Total Price:</strong> Rs {data.totalPrice}</p>
                                    </div>
                                </div>
                            </div>
                            <div className="p-6 border-b border-gray-200">
